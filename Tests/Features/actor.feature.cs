...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="CurrentPlayer attacks an monster. Then monster should not be marked as party memb" +
            "er.")]
        [Xunit.TraitAttribute("FeatureTitle", "Test that we handles actor information correctly")]
        [Xunit.TraitAttribute("Description", "CurrentPlayer attacks an monster. Then monster should not be marked as party memb" +
            "er.")]
        public virtual void CurrentPlayerAttacksAnMonster_ThenMonsterShouldNotBeMarkedAsPartyMember_()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CurrentPlayer attacks an monster. Then monster should not be marked as party memb" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 69
    testRunner.Given("Monster with name Cliffkite", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 70
    testRunner.And("Player with name Gudrun Arneson", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
#line 73
    testRunner.Then("actor with name Cliffkite that is monster exists in database", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
